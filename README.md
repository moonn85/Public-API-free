...
|               [Non-Working Days](https://github.com/gadael/icsdb)               | Cơ sở dữ liệu các tệp ICS cho các ngày không làm việc                 |    Không     |  Có   | Không Rõ|
...
|                 [CoinDesk](http://www.coindesk.com/api/)                 | Chỉ số giá Bitcoin                                                                             |    Không     |  Không| Không Rõ|
...
|                               [Frankfurter](https://www.frankfurter.app/docs)                                | Tỷ giá hối đoái, chuyển đổi tiền tệ và chuỗi thời gian                |    Không     |  Có   |   Có    |
...
|                         [Browshot](https://browshot.com/api/documentation)                          | Dễ dàng chụp ảnh màn hình của các trang web ở bất kỳ kích thước màn hình nào, dưới dạng bất kỳ thiết bị nào | `apiKey` |  Có   | Không Rõ|
...
|           [License-API](https://github.com/cmccandless/license-api/blob/master/README.md)           | API REST không chính thức cho choosealicense.com                      | Không |  Có   |   Không|
...
|                                     [Zuplo](https://zuplo.com/)                                     | Nền tảng API cho Phát triển, Triển khai và Tài liệu - thêm xác thực, giới hạn tỷ lệ và kiếm tiền nhanh chóng | `apiKey` |  Có   |   Có    |
...
|                       [Plaid](https://plaid.com/)                        | Kết nối với tài khoản ngân hàng của người dùng và truy cập dữ liệu giao dịch | `apiKey` |  Có   | Không Rõ|
...
|              [Marvel](http://developer.marvel.com)              | Truyện tranh Marvel                                                                               | `apiKey` |  Không| Không Rõ|
...
|                                          [FreeGeoIP](https://freegeoip.app/)                                           | Thông tin địa lý IP miễn phí, không cần đăng ký. Giới hạn 15k/giờ     | Không |  Có   |   Có    |
...
|                                            [ipstack](https://ipstack.com/)                                             | Định vị và xác định khách truy cập trang web bằng địa chỉ IP           | `apiKey` |  Có   | Không Rõ|
...
|          [City, Lyon Opendata](https://data.beta.grandlyon.com/fr/accueil)          | Dữ liệu mở của thành phố Lyon (Pháp)                                 | `apiKey`     |  Có   | Không Rõ|
...
| [Open Skills](https://github.com/workforce-data-initiative/skills-api/wiki/API-Overview) | Chức danh công việc, kỹ năng và dữ liệu công việc liên quan           | Không |  Không| Không Rõ|
|                        [Reed](https://www.reed.co.uk/developers)                         | Bộ tổng hợp bảng công việc                                            | `apiKey`     |  Có   | Không Rõ|
|                [Search.gov Jobs](https://search.gov/developer/jobs.html)                 | Truy cập vào danh sách các công việc hiện tại với chính phủ Hoa Kỳ     | Không |  Có   | Không Rõ|
|                  [The Muse](https://www.themuse.com/developers/api/v2)                   | Bảng công việc và hồ sơ công ty                                       | `apiKey`     |  Có   | Không Rõ|
|                         [Upwork](https://developers.upwork.com/)                         | Bảng công việc tự do và hệ thống quản lý                              | `OAuth`      |  Có   | Không Rõ|
|                        [USAJOBS](https://developer.usajobs.gov/)                         | Bảng công việc của chính phủ Hoa Kỳ                                    | `apiKey`     |  Có   | Không Rõ|
|                 [ZipRecruiter](https://www.ziprecruiter.com/publishers)                  | Ứng dụng và trang web tìm kiếm việc làm                               | `apiKey`     |  Có   | Không Rõ|
...
|                                        API                                        | Mô Tả                                                    |   Xác Thực   | HTTPS |  CORS   |
| :-------------------------------------------------------------------------------: | -------------------------------------------------------- | :----------: | :---: | :-----: |
| [Cloudmersive](https://www.cloudmersive.com/image-recognition-and-processing-api) | Chú thích hình ảnh, nhận dạng khuôn mặt, phân loại NSFW   | `apiKey`     |  Có   |   Có    |
|          [Deepcode](https://www.deepcode.ai/docs/Overview%252FOverview)           | AI để xem xét mã                                          | Không |  Có   | Không Rõ|
|                       [Dialogflow](https://dialogflow.com)                        | Xử lý ngôn ngữ tự nhiên                                   | `apiKey`     |  Có   | Không Rõ|
|                            [Keen IO](https://keen.io/)                            | Phân tích dữ liệu                                         | `apiKey`     |  Có   | Không Rõ|
|                     [Unplugg](https://unplu.gg/test_api.html)                     | API dự báo cho dữ liệu chuỗi thời gian                    | `apiKey`     |  Có   | Không Rõ|
|                             [Wit.ai](https://wit.ai/)                             | Xử lý ngôn ngữ tự nhiên                                   | `OAuth`      |  Có   | Không Rõ|
...
|                                                       API                                                        | Mô Tả                                                                 |   Xác Thực   | HTTPS |  CORS   |
| :--------------------------------------------------------------------------------------------------------------: | --------------------------------------------------------------------- | :----------: | :---: | :-----: |
|                                [AI Mastering](https://aimastering.com/api_docs/)                                 | Tự động Mastering âm nhạc                                             | `apiKey`     |  Có   |   Có    |
|                    [Bandsintown](https://app.swaggerhub.com/apis/Bandsintown/PublicAPI/3.0.1)                    | Sự kiện âm nhạc                                                       | Không |  Có   | Không Rõ|
|                                   [Deezer](https://developers.deezer.com/api)                                    | Âm nhạc                                                               | `OAuth`      |  Có   | Không Rõ|
|                                  [Discogs](https://www.discogs.com/developers/)                                  | Âm nhạc                                                               | `OAuth`      |  Có   | Không Rõ|
|                                   [Freesound](https://freesound.org/docs/api/)                                   | Mẫu âm nhạc                                                           | `apiKey`     |  Có   | Không Rõ|
|                                        [Genius](https://docs.genius.com/)                                        | Lời bài hát và kiến thức âm nhạc do cộng đồng đóng góp                | `OAuth`      |  Có   | Không Rõ|
|                               [Genrenator](https://binaryjazz.us/genrenator-api/)                                | Trình tạo thể loại âm nhạc                                            | Không |  Có   | Không Rõ|
| [iTunes Search](https://affiliate.itunes.apple.com/resources/documentation/itunes-store-web-service-search-api/) | Sản phẩm phần mềm                                                     | Không |  Có   | Không Rõ|
|                                [Jamendo](https://developer.jamendo.com/v3.0/docs)                                | Âm nhạc                                                               | `OAuth`      |  Có   | Không Rõ|
|                                       [KKBOX](https://developer.kkbox.com)                                       | Lấy thư viện âm nhạc, danh sách phát, bảng xếp hạng và thực hiện ngoài nền tảng KKBOX | `OAuth` |  Có   | Không Rõ|
|                                        [LastFm](https://www.last.fm/api)                                         | Âm nhạc                                                               | `apiKey`     |  Có   | Không Rõ|
|                                  [Lyrics.ovh](http://docs.lyricsovh.apiary.io/)                                  | API đơn giản để lấy lời bài hát                                       | Không |  Có   | Không Rõ|
|                                 [Mixcloud](https://www.mixcloud.com/developers/)                                 | Âm nhạc                                                               | `OAuth`      |  Có   |   Có    |
|                 [MusicBrainz](https://musicbrainz.org/doc/Development/XML_Web_Service/Version_2)                 | Âm nhạc                                                               | Không |  Có   | Không Rõ|
|                                 [Musixmatch](https://developer.musixmatch.com/)                                  | Âm nhạc                                                               | `apiKey`     |  Có   | Không Rõ|
|                               [Openwhyd](https://openwhyd.github.io/openwhyd/API)                                | Tải xuống danh sách phát được quản lý của các bản nhạc phát trực tuyến (YouTube, SoundCloud, v.v.) | Không |  Có   |   Không|
|                             [SearchLy](https://www.github.com/AlbertSuarez/searchly)                             | Tìm kiếm sự tương đồng dựa trên lời bài hát                           | Không |  Có   | Không Rõ|
|                                 [Songkick](https://www.songkick.com/developer/)                                  | Sự kiện âm nhạc                                                       | `OAuth`      |  Có   | Không Rõ|
|                                 [Songsterr](https://www.songsterr.com/a/wa/api/)                                 | Cung cấp các tab và hợp âm cho guitar, bass và trống                  | Không |  Có   | Không Rõ|
|                                 [SoundCloud](https://developers.soundcloud.com/)                                 | Cho phép người dùng tải lên và chia sẻ âm thanh                       | `OAuth`      |  Có   | Không Rõ|
|                       [Spotify](https://beta.developer.spotify.com/documentation/web-api/)                       | Xem danh mục âm nhạc của Spotify, quản lý thư viện của người dùng, nhận đề xuất và nhiều hơn nữa | `OAuth` |  Có   | Không Rõ|
|                                   [TasteDive](https://tastedive.com/read/api)                                    | API nghệ sĩ tương tự (cũng hoạt động cho phim và chương trình truyền hình) | `apiKey` |  Có   | Không Rõ|
|                              [TheAudioDB](https://www.theaudiodb.com/api_guide.php)                              | Âm nhạc                                                               | `apiKey`     |  Có   | Không Rõ|
|                                  [Vagalume](https://api.vagalume.com.br/docs/)                                   | Lời bài hát và kiến thức âm nhạc do cộng đồng đóng góp                | `apiKey`     |  Có   | Không Rõ|
...
|                                 API                                 | Mô Tả                                                                 |   Xác Thực   | HTTPS |  CORS   |
| :-----------------------------------------------------------------: | --------------------------------------------------------------------- | :----------: | :---: | :-----: |
|            [Associated Press](https://developer.ap.org/)            | Tìm kiếm tin tức và siêu dữ liệu từ Associated Press                  | `apiKey`     |  Có   | Không Rõ|
| [Chronicling America](http://chroniclingamerica.loc.gov/about/api/) | Cung cấp quyền truy cập vào hàng triệu trang báo lịch sử của Hoa Kỳ từ Thư viện Quốc hội | Không |  Không| Không Rõ|
|              [Currents](https://currentsapi.services/)              | Tin tức mới nhất được xuất bản trên nhiều nguồn tin tức, blog và diễn đàn | `apiKey` |  Có   |   Có    |
|          [Feedbin](https://github.com/feedbin/feedbin-api)          | Trình đọc RSS                                                        | `OAuth`      |  Có   | Không Rõ|
|                   [Finlight](https://finlight.me)                   | Tin tức tài chính thời gian thực với cảm xúc và nội dung bài viết     | `apiKey`     |  Có   |   Có    |
|          [New York Times](https://developer.nytimes.com/)           | Cung cấp tin tức                                                     | `apiKey`     |  Có   | Không Rõ|
|                    [News](https://newsapi.org/)                     | Tiêu đề hiện đang được xuất bản trên nhiều nguồn tin tức và blog      | `apiKey`     |  Có   | Không Rõ|
|                     [OkSurf](https://ok.surf/)                      | Tin tức Google miễn phí với Hình ảnh OG                              | Không |  Có   |   Có    |
|        [The Guardian](http://open-platform.theguardian.com/)        | Truy cập tất cả nội dung mà Guardian tạo, được phân loại theo thẻ và phần | `apiKey` |  Có   | Không Rõ|
|        [The Old Reader](https://github.com/theoldreader/api)        | Trình đọc RSS                                                        | `apiKey`     |  Có   | Không Rõ|
...
|                                     API                                     | Mô Tả                                                                 |   Xác Thực   | HTTPS |  CORS   |
| :-------------------------------------------------------------------------: | --------------------------------------------------------------------- | :----------: | :---: | :-----: |
|                 [18F](http://18f.github.io/API-All-the-X/)                  | Phát triển API của Chính phủ Liên bang Hoa Kỳ không chính thức        | Không |  Không| Không Rõ|
|                [Archive.org](https://archive.readme.io/docs)                | Lưu trữ Internet                                                     | Không |  Có   | Không Rõ|
|                    [Callook.info](https://callook.info)                     | Ký hiệu đài phát thanh nghiệp dư của Hoa Kỳ                           | Không |  Có   | Không Rõ|
|                         [CARTO](https://carto.com/)                         | Dự đoán Thông tin Vị trí                                             | `apiKey`     |  Có   | Không Rõ|
|               [CivicFeed](https://developers.civicfeed.com/)                | Bài báo và tập dữ liệu công cộng                                      | `apiKey`     |  Có   | Không Rõ|
|     [Enigma Public](http://docs.enigma.com/public/public_v20_api_about)     | Bộ sưu tập dữ liệu công cộng rộng nhất                                | `apiKey`     |  Có   |   Có    |
|                  [fonoApi](https://fonoapi.freshpixl.com/)                  | Mô tả thiết bị di động                                                | Không |  Có   | Không Rõ|
|          [French Address Search](https://geo.api.gouv.fr/adresse)           | Tìm kiếm địa chỉ thông qua Chính phủ Pháp                             | Không |  Có   | Không Rõ|
|              [Fruits](https://fruits-api.netlify.app/graphql)               | Thông tin về cây ăn quả trên thế giới                                 | Không |  Có   |   Không|
|                 [LinkPreview](https://www.linkpreview.net)                  | Nhận tóm tắt định dạng JSON với tiêu đề, mô tả và hình ảnh xem trước cho bất kỳ URL nào được yêu cầu | `apiKey` |  Có   |   Có    |
|                    [Microlink.io](https://microlink.io)                     | Trích xuất dữ liệu có cấu trúc từ bất kỳ trang web nào                | Không |  Có   |   Có    |
| [OpenCorporates](http://api.opencorporates.com/documentation/API-Reference) | Dữ liệu về các thực thể và giám đốc doanh nghiệp ở nhiều quốc gia     | `apiKey`     |  Có   | Không Rõ|
|                      [Quandl](https://www.quandl.com/)                      | Dữ liệu Thị trường Chứng khoán                                        | Không |  Có   | Không Rõ|
|       [Recreation Information Database](https://ridb.recreation.gov/)       | Các khu vực giải trí, đất liên bang, địa điểm lịch sử, bảo tàng và các điểm tham quan/tài nguyên khác (Hoa Kỳ) | `apiKey` |  Có   | Không Rõ|
|                     [Scoop.it](http://www.scoop.it/dev)                     | Dịch vụ Quản lý Nội dung                                             | `apiKey`     |  Không| Không Rõ|
|                [Teleport](https://developers.teleport.org/)                 | Dữ liệu Chất lượng Cuộc sống                                         | Không |  Có   | Không Rõ|
|    [Universities List](https://github.com/Hipo/university-domains-list)     | Tên, quốc gia và tên miền của các trường đại học                      | Không |  Có   | Không Rõ|
|                 [University of Oslo](https://data.uio.no/)                  | Các khóa học, video bài giảng, thông tin chi tiết về các khóa học, v.v. cho Đại học Oslo (Na Uy) | Không |  Có   | Không Rõ|
|                 [UPC database](https://upcdatabase.org/api)                 | Hơn 1,5 triệu số mã vạch từ khắp nơi trên thế giới                    | `apiKey`     |  Có   | Không Rõ|
|         [Wikidata](https://www.wikidata.org/w/api.php?action=help)          | Cơ sở tri thức được chỉnh sửa cộng tác do Wikimedia Foundation điều hành | `OAuth` |  Có   | Không Rõ|
|          [Wikipedia](https://www.mediawiki.org/wiki/API:Main_page)          | Bách khoa toàn thư Mediawiki                                         | Không |  Có   | Không Rõ|
|          [Yelp](https://www.yelp.com/developers/documentation/v3)           | Tìm Doanh nghiệp Địa phương                                          | `OAuth`      |  Có   | Không Rõ|
...
|                           API                           | Mô Tả                          |   Xác Thực   | HTTPS |  CORS   |
| :-----------------------------------------------------: | ------------------------------ | :----------: | :---: | :-----: |
| [Drupal.org](https://www.drupal.org/drupalorg/docs/api) | Drupal.org                     | Không |  Có   | Không Rõ|
|   [Evil Insult Generator](https://evilinsult.com/api)   | Lời lăng mạ ác ý               | Không |  Có   |   Có    |
|        [Libraries.io](https://libraries.io/api)         | Thư viện phần mềm mã nguồn mở  | `apiKey`     |  Có   | Không Rõ|
|  [The Odin Project](https://github.com/theodinproject)  | theodinproject.com             | Không |  Có   |   Có    |
...
|                                      API                                      | Mô Tả                          |   Xác Thực   | HTTPS |  CORS   |
| :---------------------------------------------------------------------------: | ------------------------------ | :----------: | :---: | :-----: |
|                      [EPO](https://developers.epo.org/)                       | Hệ thống tìm kiếm bằng sáng chế châu Âu | `OAuth` |  Có   | Không Rõ|
| [TIPO](https://tiponet.tipo.gov.tw/Gazette/OpenData/OD/OD05.aspx?QryDS=API00) | Hệ thống tìm kiếm bằng sáng chế Đài Loan | `apiKey` |  Có   | Không Rõ|
| [USPTO](https://www.uspto.gov/learning-and-resources/open-data-and-mobility)  | Dịch vụ API bằng sáng chế của Hoa Kỳ     | Không |  Có   | Không Rõ|
...
|                               API                               | Mô Tả                                                                 |   Xác Thực   | HTTPS |  CORS   |
| :-------------------------------------------------------------: | --------------------------------------------------------------------- | :----------: | :---: | :-----: |
|            [Advice Slip](http://api.adviceslip.com/)            | Tạo các lời khuyên ngẫu nhiên                                         | Không |  Có   | Không Rõ|
|          [chucknorris.io](https://api.chucknorris.io)           | API JSON cho các truyện cười về Chuck Norris được chọn lọc thủ công   | Không |  Có   | Không Rõ|
|               [FavQs.com](https://favqs.com/api)                | FavQs cho phép bạn thu thập, khám phá và chia sẻ các câu trích dẫn yêu thích của mình | `apiKey` |  Có   | Không Rõ|
|           [Forismatic](http://forismatic.com/en/api/)           | Câu trích dẫn truyền cảm hứng                                         | Không |  Không| Không Rõ|
|              [HideMyMind](https://hidemymind.com/)              | Dịch vụ ghi chú riêng tư, được mã hóa với quyền truy cập liên kết     | Không |  Có   | Không Rõ|
|        [Hindi Quotes](https://hindi-quotes.vercel.app/)         | Nhận các câu trích dẫn tiếng Hindi ngẫu nhiên thuộc các danh mục khác nhau. | Không |  Có   |   Có    |
| [Hindi Quotes and Shayari](https://purevichar.in/tool/apitool)  | Nhận các câu trích dẫn và shayari tiếng Hindi thuộc các danh mục khác nhau miễn phí. | Không |  Không| Không Rõ|
|        [icanhazdadjoke](https://icanhazdadjoke.com/api)         | Bộ sưu tập truyện cười của bố lớn nhất trên internet                  | Không |  Có   | Không Rõ|
|                [kanye.rest](https://kanye.rest)                 | API REST cho các câu trích dẫn ngẫu nhiên của Kanye West              | Không |  Có   |   Có    |
|       [Medium](https://github.com/Medium/medium-api-docs)       | Cộng đồng độc giả và nhà văn cung cấp các quan điểm độc đáo về ý tưởng | `OAuth` |  Có   | Không Rõ|
|            [Meme](https://github.com/D3vd/Meme_Api)             | API JSON cho một meme ngẫu nhiên được cạo từ reddit                   | Không |  Có   | Không Rõ|
|        [NaMoMemes](https://github.com/theIYD/NaMoMemes)         | Meme về Narendra Modi                                                 | Không |  Có   | Không Rõ|
| [Programming Quotes](https://programming-quotesapi.vercel.app/) | Một API tạo ra các câu trích dẫn từ các lập trình viên                | Không |  Có   |   Có    |
| [Quote Garden](https://pprathameshmore.github.io/QuoteGarden/)  | API REST cho hơn 5000 câu trích dẫn nổi tiếng                         | Không |  Có   | Không Rõ|
|        [Quoterism](https://www.quoterism.com/developer)         | Câu trích dẫn truyền cảm hứng                                         | Không |  Có   | Không Rõ|
|       [Quotes on Design](https://quotesondesign.com/api/)       | Câu trích dẫn truyền cảm hứng                                         | Không |  Có   | Không Rõ|
|         [Riddles API](https://riddles-api.vercel.app/)          | Nhận các câu đố ngẫu nhiên trong mỗi lần gọi API.                     | Không |  Có   |   Có    |
|         [Traitify](https://app.traitify.com/developer)          | Đánh giá, thu thập và phân tích Tính cách                            | Không |  Có   | Không Rõ|
|          [tronalddump.io](https://www.tronalddump.io)           | API & kho lưu trữ web cho những điều Donald Trump đã nói             | Không |  Có   | Không Rõ|
...
|                          API                          | Mô Tả                                                |   Xác Thực   | HTTPS |  CORS   |
| :---------------------------------------------------: | ---------------------------------------------------- | :----------: | :---: | :-----: |
|    [Flickr](https://www.flickr.com/services/api/)     | Dịch vụ Flickr                                       | `OAuth`      |  Có   | Không Rõ|
| [Getty Images](http://developers.gettyimages.com/en/) | Xây dựng các ứng dụng bằng cách sử dụng hình ảnh mạnh mẽ nhất thế giới | `OAuth` |  Có   | Không Rõ|
|      [Giphy](https://developers.giphy.com/docs/)      | Lấy tất cả các gif của bạn                           | `apiKey`     |  Có   | Không Rõ|
|          [Gyazo](https://gyazo.com/api/docs)          | Tải lên hình ảnh                                     | `apiKey`     |  Có   | Không Rõ|
|          [Imgur](https://apidocs.imgur.com/)          | Hình ảnh                                             | `OAuth`      |  Có   | Không Rõ|
|        [Lorem Picsum](https://picsum.photos/)         | Hình ảnh từ Unsplash                                 | Không |  Có   | Không Rõ|
|          [ObjectCut](https://objectcut.com/)          | Loại bỏ nền hình ảnh                                 | `apiKey`     |  Có   |   Có    |
|         [Pexels](https://www.pexels.com/api/)         | Ảnh và video miễn phí                                | `apiKey`     |  Có   |   Có    |
| [Pixabay](https://pixabay.com/sk/service/about/api/)  | Nhiếp ảnh                                            | `apiKey`     |  Có   | Không Rõ|
|        [PlaceKitten](https://placekitten.com/)        | Hình ảnh giữ chỗ mèo có thể thay đổi kích thước      | Không |  Có   | Không Rõ|
|    [ScreenShotLayer](https://screenshotlayer.com)     | URL 2 Hình ảnh                                       | Không |  Có   | Không Rõ|
|      [Unsplash](https://unsplash.com/developers)      | Nhiếp ảnh                                            | `OAuth`      |  Có   | Không Rõ|
|      [Wallhaven](https://wallhaven.cc/help/api)       | Hình nền                                             | `apiKey`     |  Có   | Không Rõ|
...
|                                      API                                       | Mô Tả                                                                 |   Xác Thực   | HTTPS |  CORS   |
| :----------------------------------------------------------------------------: | --------------------------------------------------------------------- | :----------: | :---: | :-----: |
|                   [arcsecond.io](https://api.arcsecond.io/)                    | Nhiều nguồn dữ liệu thiên văn học                                     | Không |  Có   | Không Rõ|
|                    [CORE](https://core.ac.uk/services#api)                     | Truy cập vào các bài báo nghiên cứu Truy cập Mở của thế giới          | `apiKey`     |  Có   | Không Rõ|
|                        [GBIF](http://api.gbif.org/v1/)                         | Cơ sở Thông tin Đa dạng Sinh học Toàn cầu                             | Không |  Có   |   Có    |
|         [iDigBio](https://github.com/idigbio/idigbio-search-api/wiki)          | Truy cập hàng triệu mẫu vật bảo tàng từ các tổ chức trên khắp thế giới | Không |  Có   | Không Rõ|
|                [ITIS](https://www.itis.gov/ws_description.html)                | Hệ thống Thông tin Phân loại Tích hợp                                 | Không |  Có   | Không Rõ|
|         [Launch Library](https://launchlibrary.net/docs/1.3/api.html)          | Các vụ phóng không gian sắp tới                                       | Không |  Có   | Không Rõ|
|               [Minor Planet Center](http://www.asterank.com/mpc)               | Thông tin Asterank.com                                                | Không |  Không| Không Rõ|
|                          [NASA](https://api.nasa.gov)                          | Dữ liệu NASA, bao gồm cả hình ảnh                                     | Không |  Có   | Không Rõ|
|                        [Newton](https://newton.now.sh/)                        | Máy tính Toán học Ký hiệu và Số học                                    | Không |  Có   | Không Rõ|
|                   [Numbers](https://math.tools/api/numbers/)                   | Số của ngày, tạo số ngẫu nhiên, sự thật về số và bất cứ điều gì khác bạn muốn làm với số | `apiKey` |  Có   |   Có    |
|                        [Numbers](http://numbersapi.com)                        | Sự thật về số                                                         | Không |  Không| Không Rõ|
|             [Open Notify](http://open-notify.org/Open-Notify-API/)             | Các phi hành gia ISS, vị trí hiện tại, v.v.                           | Không |  Không| Không Rõ|
|               [Open Science Framework](https://developer.osf.io)               | Kho lưu trữ và lưu trữ các thiết kế nghiên cứu, tài liệu nghiên cứu, dữ liệu, bản thảo, v.v. | Không |  Có   | Không Rõ|
|                     [SHARE](https://share.osf.io/api/v2/)                      | Một tập dữ liệu miễn phí, mở về các hoạt động nghiên cứu và học thuật | Không |  Có   | Không Rõ|
|                [SpaceX](https://github.com/r-spacex/SpaceX-API)                | Dữ liệu về công ty, phương tiện, bệ phóng và vụ phóng                 | Không |  Có   | Không Rõ|
|              [Sunrise and Sunset](https://sunrise-sunset.org/api)              | Thời gian mặt trời mọc và lặn cho một vĩ độ và kinh độ nhất định      | Không |  Có   | Không Rõ|
| [USGS Earthquake Hazards Program](https://earthquake.usgs.gov/fdsnws/event/1/) | Dữ liệu động đất thời gian thực                                       | Không |  Có   | Không Rõ|
|             [USGS Water Services](https://waterservices.usgs.gov/)             | Thông tin về chất lượng và mực nước cho các con sông và hồ            | Không |  Có   | Không Rõ|
|  [World Bank](https://datahelpdesk.worldbank.org/knowledgebase/topics/125589)  | Dữ liệu Thế giới                                                      | Không |  Không| Không Rõ|
...
|                                             API                                             | Mô Tả                                                                                          |   Xác Thực   | HTTPS |  CORS   |
| :-----------------------------------------------------------------------------------------: | ---------------------------------------------------------------------------------------------- | :----------: | :---: | :-----: |
|                             [Censys.io](https://censys.io/api)                              | Công cụ tìm kiếm cho các máy chủ và thiết bị kết nối Internet                                  | `apiKey`     |  Có   |   Không|
|                         [CRXcavator](https://crxcavator.io/apidocs)                         | Chấm điểm rủi ro tiện ích mở rộng Chrome                                                       | `apiKey`     |  Có   | Không Rõ|
|                              [FishFish](https://fishfish.gg/)                               | Dự án tình nguyện về an ninh mạng tập trung vào cung cấp tài nguyên và dịch vụ cải thiện an toàn trên Discord | Không |  Có   | Không Rõ|
|                     [HaveIBeenPwned](https://haveibeenpwned.com/API/v3)                     | Mật khẩu đã từng bị lộ trong các vụ vi phạm dữ liệu                                            | `apiKey`     |  Có   | Không Rõ|
| [National Vulnerability Database](https://nvd.nist.gov/vuln/Data-Feeds/JSON-feed-changelog) | Cơ sở dữ liệu lỗ hổng quốc gia của Hoa Kỳ                                                      | Không |  Có   | Không Rõ|
|                         [phish.directory](https://phish.directory/)                         | API cho phish.directory, một công cụ chống lừa đảo do cộng đồng điều hành. Giúp bắt, ngăn chặn và lập danh mục các liên kết & nỗ lực lừa đảo. | `apiKey` |  Có   | Không Rõ|
|                     [Secrets-APi](https://secrets-api.appbrewery.com/)                      | Được sử dụng cho mục đích học tập, tìm hiểu tất cả các loại bảo mật với API này                | Tất cả |  Có   | Không Rõ|
|                    [SecurityTrails](https://securitytrails.com/corp/api)                    | Thông tin liên quan đến tên miền và IP như bản ghi WHOIS và DNS hiện tại và lịch sử            | `apiKey`     |  Có   | Không Rõ|
|                           [Shodan](https://developer.shodan.io/)                            | Công cụ tìm kiếm cho các thiết bị kết nối Internet                                             | `apiKey`     |  Có   | Không Rõ|
|                          [UK Police](https://data.police.uk/docs/)                          | Dữ liệu cảnh sát Vương quốc Anh                                                                | Không |  Có   | Không Rõ|
|                           [Whoisfreaks](https://whoisfreaks.com/)                           | Thông tin liên quan đến tên miền và DNS sẽ trang bị cho tổ chức khả năng phân tích bề mặt tấn công và thông tin tình báo mối đe dọa toàn diện để tăng cường bảo mật | `apiKey` |  Có   |   Không|
|                          [WhoisJSONApi](https://whoisjsonapi.com/)                          | Thông tin WHOIS tên miền để phát hiện và ngăn chặn các mối đe dọa trực tuyến, nâng cao an toàn trực tuyến tổng thể cho các cá nhân và tổ chức | `apiKey` |  Có   |   Không|
...
|                                  API                                  | Mô Tả                                                                 |   Xác Thực   | HTTPS |  CORS   |
| :-------------------------------------------------------------------: | --------------------------------------------------------------------- | :----------: | :---: | :-----: |
| [Best Buy](https://bestbuyapis.github.io/api-documentation/#overview) | Sản phẩm, Tùy chọn Mua, Danh mục, Đề xuất, Cửa hàng và Thương mại     | `apiKey`     |  Có   | Không Rõ|
|            [Bratabase](https://developers.bratabase.com/)             | Cơ sở dữ liệu về các loại kích cỡ áo ngực khác nhau                   | `OAuth`      |  Có   | Không Rõ|
|                [eBay](https://go.developer.ebay.com/)                 | Bán và Mua trên eBay                                                  | `OAuth`      |  Có   | Không Rõ|
|                   [Wegmans](https://dev.wegmans.io)                   | Chợ Thực phẩm Wegmans                                                 | `apiKey`     |  Có   | Không Rõ|
...
|                                  API                                   | Mô Tả                                                                 |   Xác Thực   | HTTPS |  CORS   |
| :--------------------------------------------------------------------: | --------------------------------------------------------------------- | :----------: | :---: | :-----: |
|              [Buffer](https://buffer.com/developers/api)               | Truy cập vào các bản cập nhật đang chờ xử lý và đã gửi trong Buffer   | `OAuth`      |  Có   | Không Rõ|
|            [Cisco Spark](https://developer.ciscospark.com)             | Phần mềm Hợp tác Nhóm                                                 | `OAuth`      |  Có   | Không Rõ|
|        [Discord](https://discordapp.com/developers/docs/intro)         | Tạo bot cho Discord, tích hợp Discord vào một nền tảng bên ngoài      | `OAuth`      |  Có   | Không Rõ|
|              [Disqus](https://disqus.com/api/docs/auth/)               | Giao tiếp với dữ liệu Disqus                                          | `OAuth`      |  Có   | Không Rõ|
|              [Facebook](https://developers.facebook.com/)              | Đăng nhập Facebook, Chia sẻ trên FB, Plugin Xã hội, Phân tích và nhiều hơn nữa | `OAuth` |  Có   | Không Rõ|
|            [Foursquare](https://developer.foursquare.com/)             | Tương tác với người dùng và địa điểm Foursquare (checkin dựa trên vị trí địa lý, ảnh, mẹo, sự kiện, v.v.) | `OAuth` |  Có   | Không Rõ|
|      [Full Contact](https://www.fullcontact.com/developer/docs/)       | Lấy hồ sơ Mạng Xã hội và Thông tin liên hệ                            | `OAuth`      |  Có   | Không Rõ|
|            [HackerNews](https://github.com/HackerNews/API)             | Tin tức xã hội cho CS và khởi nghiệp                                  | Không |  Có   | Không Rõ|
|           [Instagram](https://www.instagram.com/developer/)            | Đăng nhập Instagram, Chia sẻ trên Instagram, Plugin Xã hội và nhiều hơn nữa | `OAuth` |  Có   | Không Rõ|
|            [Meetup.com](https://www.meetup.com/meetup_api/)            | Dữ liệu về các buổi gặp mặt từ Meetup.com                             | `apiKey`     |  Có   | Không Rõ|
|                 [MySocialApp](https://mysocialapp.io)                  | Các tính năng Mạng Xã hội liền mạch, API, SDK cho bất kỳ ứng dụng nào | `apiKey`     |  Có   | Không Rõ|
| [Open Collective](https://docs.opencollective.com/help/developers/api) | Lấy dữ liệu Open Collective                                           | Không |  Có   | Không Rõ|
|             [Pinterest](https://developers.pinterest.com/)             | Danh mục ý tưởng của thế giới                                         | `OAuth`      |  Có   | Không Rõ|
|               [PWRTelegram bot](https://pwrtelegram.xyz)               | Phiên bản tăng cường của API bot Telegram                             | `apiKey`     |  Có   | Không Rõ|
|                [Reddit](https://www.reddit.com/dev/api)                | Trang chủ của internet                                                | `OAuth`      |  Có   | Không Rõ|
|               [SocialData API](https://socialdata.tools)               | API không chính thức để đọc dữ liệu Twitter                           | `apiKey`     |  Có   |   Không|
|                    [Slack](https://api.slack.com/)                     | Nhắn tin tức thì cho nhóm                                             | `OAuth`      |  Có   | Không Rõ|
|           [Telegram Bot](https://core.telegram.org/bots/api)           | Phiên bản HTTP đơn giản hóa của API MTProto cho bot                   | `OAuth`      |  Có   | Không Rõ|
|   [Telegram MTProto](https://core.telegram.org/api#getting-started)    | Đọc và ghi dữ liệu Telegram                                           | `apiKey`     |  Có   | Không Rõ|
|          [Trash Nothing](https://trashnothing.com/developer)           | Một cộng đồng tái chế miễn phí với hàng nghìn mặt hàng miễn phí được đăng mỗi ngày | `OAuth` |  Có   |   Có    |
|            [Tumblr](https://www.tumblr.com/docs/en/api/v2)             | Đọc và ghi dữ liệu Tumblr                                             | `OAuth`      |  Có   | Không Rõ|
|                  [Twitch](https://dev.twitch.tv/docs)                  | API Phát trực tiếp trò chơi                                           | `OAuth`      |  Có   | Không Rõ|
|            [Twitter](https://developer.twitter.com/en/docs)            | Đọc và ghi dữ liệu Twitter                                            | `OAuth`      |  Có   |   Không|
|                     [vk](https://vk.com/dev/sites)                     | Đọc và ghi dữ liệu vk                                                 | `OAuth`      |  Có   | Không Rõ|
|              [SharedCount](http://docs.sharedcount.com/)               | Theo dõi lượt chia sẻ trên Pinterest & Facebook                       | `apiKey`     |  Có   | Không Rõ|
|                  [TwitterApi](http://twitterapi.io/)                   | API đọc dữ liệu Twitter hàng loạt                                     | `apiKey`     |  Có   |   Không|
...
|                                  API                                  | Mô Tả                                                                 |      Xác Thực       | HTTPS |  CORS   |
| :-------------------------------------------------------------------: | --------------------------------------------------------------------- | :-----------------: | :---: | :-----: |
|                 [balldontlie](https://balldontlie.io)                 | Ballldontlie cung cấp quyền truy cập vào dữ liệu thống kê từ NBA      | Không |  Có   |   Có    |
|       [BikeWise](https://www.bikewise.org/documentation/api_v2)       | Bikewise là nơi để tìm hiểu về và báo cáo các vụ tai nạn xe đạp, nguy hiểm và trộm cắp | Không |  Có   | Không Rõ|
|         [Canadian Football League (CFL)](http://api.cfl.ca/)          | API JSON chính thức cung cấp số liệu thống kê về giải đấu, đội và cầu thủ thời gian thực về CFL | `apiKey` |  Có   |   Không|
|        [Cartola FC](https://github.com/wgenial/cartrolandofc)         | API Cartola FC dùng để kiểm tra điểm số tạm thời của đội bạn          | Không |  Có   | Không Rõ|
|                [City Bikes](http://api.citybik.es/v2/)                | Xe đạp thành phố trên khắp thế giới                                   | Không |  Không| Không Rõ|
|                  [Ergast F1](http://ergast.com/mrd/)                  | Dữ liệu F1 từ khi bắt đầu các giải vô địch thế giới vào năm 1950      | Không |  Có   | Không Rõ|
|                      [F1 API](https://f1api.dev)                      | Dữ liệu F1 miễn phí theo thời gian thực với gói NPM riêng             | Không |  Có   | Không Rõ|
|        [F1 Data API](https://github.com/Jacobbrewer1/f1-data)         | API dữ liệu Công thức 1 cung cấp dữ liệu từ Lưu trữ F1 từ năm 1950    | Không |  Có   |   Không|
|                   [Fitbit](https://dev.fitbit.com/)                   | Thông tin Fitbit                                                      | `OAuth`      |  Có   | Không Rõ|
|    [Football (Soccer) Videos](https://www.scorebat.com/video-api/)    | Mã nhúng cho các bàn thắng và điểm nổi bật từ Premier League, Bundesliga, Serie A và nhiều hơn nữa | Không |  Có   |   Có    |
|      [Football Prediction](https://boggio-analytics.com/fp-api/)      | Dự đoán các trận đấu bóng đá sắp tới, tỷ lệ cược, kết quả và thống kê | `X-Mashape-Key` |  Có   | Không Rõ|
|        [Football-Data.org](http://api.football-data.org/index)        | Dữ liệu bóng đá                                                       | Không |  Không| Không Rõ|
|      [Golf-Data](https://github.com/Jacobbrewer1/golf-data-docs)      | API dữ liệu golf với thông tin về sân golf, câu lạc bộ và lỗ golf     | Không |  Có   |   Không|
|           [JCDecaux Bike](https://developer.jcdecaux.com/)            | Xe đạp tự phục vụ của JCDecaux                                        | `apiKey`     |  Có   | Không Rõ|
| [NBA Stats](https://any-api.com/nba_com/nba_com/docs/API_Description) | Thống kê NBA hiện tại và lịch sử                                      | Không |  Có   | Không Rõ|
|       [NHL Records and Stats](https://gitlab.com/dword4/nhlapi)       | Dữ liệu và thống kê lịch sử NHL                                       | Không |  Có   | Không Rõ|
|                [Strava](https://strava.github.io/api/)                | Kết nối với các vận động viên, hoạt động và nhiều hơn nữa             | `OAuth`      |  Có   | Không Rõ|
|                [SuredBits](https://suredbits.com/api/)                | Truy vấn dữ liệu thể thao, bao gồm các đội, cầu thủ, trận đấu, điểm số và thống kê | Không |  Không|   Không|
|          [TheSportsDB](https://www.thesportsdb.com/api.php)           | Dữ liệu và Hình ảnh Thể thao do Đám đông cung cấp                     | `apiKey`     |  Có   |   Có    |
|                [Wger](https://wger.de/en/software/api)                | Dữ liệu quản lý tập luyện như bài tập, cơ bắp hoặc thiết bị           | `apiKey`     |  Có   | Không Rõ|
|                 [CricData](https://cricketdata.org/)                  | API dữ liệu Cricket tối ưu - Điểm số, Bảng điểm, Dữ liệu người chơi, API giả tưởng | `apiKey` |  Có   | Không Rõ|
...
|                                      API                                      | Mô Tả                                                                 |   Xác Thực   | HTTPS |  CORS   |
| :---------------------------------------------------------------------------: | --------------------------------------------------------------------- | :----------: | :---: | :-----: |
|                [Bacon Ipsum](https://baconipsum.com/json-api/)                | Trình tạo Lorem Ipsum nhiều thịt hơn                                  | Không |  Có   | Không Rõ|
| [Beeceptor's CRUD APIs](https://beeceptor.com/crud-api/?ref=public-api-lists) | API CRUD có trạng thái miễn phí                                       | Không |  Có   |   Có    |
|               [Dicebear Avatars](https://avatars.dicebear.com/)               | Tạo hình đại diện pixel-art ngẫu nhiên                                | Không |  Có   |   Không|
|                       [FakeJSON](https://fakejson.com)                        | Dịch vụ tạo dữ liệu kiểm tra và giả                                   | `apiKey`     |  Có   |   Có    |
|                      [JSONing](https://jsoning.com/api/)                      | Dữ liệu giả để tạo mẫu                                                | Không |  Có   |   Có    |
|            [JSONPlaceholder](http://jsonplaceholder.typicode.com/)            | Dữ liệu giả để kiểm tra và tạo mẫu                                    | Không |  Không| Không Rõ|
|                       [Loripsum](http://loripsum.net/)                        | Trình tạo "lorem ipsum" không tệ                                       | Không |  Không| Không Rõ|
|                [Micro-Jaymock](https://micro-jaymock.now.sh/)                 | Dịch vụ vi mô giả lập API nhỏ để tạo dữ liệu JSON giả                  | Không |  Có   |   Không|
|                         [Mockae](https://mockae.com/)                         | API REST giả được cung cấp bởi Lua                                    | Không |  Có   |   Có    |
|                      [RandomUser](https://randomuser.me)                      | Tạo dữ liệu người dùng ngẫu nhiên                                     | Không |  Có   | Không Rõ|
|                       [RoboHash](https://robohash.org/)                       | Tạo hình đại diện robot/người ngoài hành tinh ngẫu nhiên              | Không |  Có   | Không Rõ|
|       [This Person Does not Exist](https://thispersondoesnotexist.com)        | Tạo khuôn mặt đời thực của những người không tồn tại                  | Không |  Có   | Không Rõ|
|                  [UI Names](https://github.com/thm/uinames)                   | Tạo tên giả ngẫu nhiên                                                | Không |  Có   | Không Rõ|
|               [UUID Generator](https://www.uuidtools.com/docs)                | Tạo UUID                                                              | Không |  Có   |   Không|
|                        [Yes No](https://yesno.wtf/api)                        | Tạo có hoặc không ngẫu nhiên                                          | Không |  Có   | Không Rõ|
|                [Randommer](https://randommer.io/randommer-api)                | Trình tạo dữ liệu ngẫu nhiên                                          | `apiKey`     |  Có   |   Có    |
|                  [Softwium](https://softwium.com/fake-api/)                   | Dữ liệu kiểm tra để kiểm tra và tạo mẫu                               | Không |  Có   |   Có    |
...
|                                                            API                                                            | Mô Tả                                                                 |   Xác Thực   | HTTPS |  CORS   |
| :-----------------------------------------------------------------------------------------------------------------------: | --------------------------------------------------------------------- | :----------: | :---: | :-----: |
|                                      [Aylien Text Analysis](http://docs.aylien.com/)                                      | Một bộ sưu tập các API truy xuất thông tin và ngôn ngữ tự nhiên       | `apiKey`     |  Có   | Không Rõ|
|                     [Cloudmersive Natural Language Processing](https://www.cloudmersive.com/nlp-api)                      | Xử lý ngôn ngữ tự nhiên và phân tích văn bản                          | `apiKey`     |  Có   |   Có    |
|                                      [Detect Language](https://detectlanguage.com/)                                       | Phát hiện ngôn ngữ văn bản                                            | `apiKey`     |  Có   | Không Rõ|
|                          [Google Cloud Natural](https://cloud.google.com/natural-language/docs/)                          | Công nghệ hiểu ngôn ngữ tự nhiên, bao gồm phân tích cảm xúc, thực thể và cú pháp | `apiKey` |  Có   | Không Rõ|
|                        [ParallelDots AI APIs](https://apis.paralleldots.com/text_docs/index.html)                         | Bộ API Phân tích Văn bản như phân tích cảm xúc, trích xuất từ khóa và trích xuất thực thể được đặt tên | `apiKey` |  Có   |   Có    |
|                                       [Semantira](https://semantria.readme.io/docs)                                       | Phân tích văn bản với phân tích cảm xúc, phân loại & trích xuất thực thể được đặt tên | `OAuth` |  Có   | Không Rõ|
|                                           [Spam Hunter](https://spam-hunter.ru)                                           | Dịch vụ miễn phí để phân loại văn bản là spam bằng cách sử dụng ML    | `apiKey`     |  Có   |   Có    |
| [Watson Natural Language Understanding](https://www.ibm.com/watson/developercloud/natural-language-understanding/api/v1/) | Xử lý ngôn ngữ tự nhiên để phân tích văn bản nâng cao                 | `OAuth`      |  Có   | Không Rõ|
|                                        [Yomi](https://github.com/ookii-tsuki/yomi)                                        | API web phân tích hình thái và bộ phân tách tiếng Nhật                | Không |  Có   |   Có    |
...
|                       API                        | Mô Tả                                                                 |   Xác Thực   | HTTPS |  CORS   |
| :----------------------------------------------: | --------------------------------------------------------------------- | :----------: | :---: | :-----: |
|     [Let's Count](https://letscountapi.com)      | Tạo, truy xuất, cập nhật, tăng và giảm bộ đếm                         | Không |  Có   | Không Rõ|
|         [Postmon](http://postmon.com.br)         | Một API để truy vấn mã zip và đơn đặt hàng của Brazil một cách dễ dàng, nhanh chóng và miễn phí | Không |  Không| Không Rõ|
|  [Sweden](https://developer.postnord.com/docs2)  | Cung cấp thông tin về các bưu kiện đang vận chuyển                    | `apiKey`     |  Không| Không Rõ|
|    [UPS](https://www.ups.com/upsdeveloperkit)    | Thông tin lô hàng và địa chỉ                                          | `apiKey`     |  Có   | Không Rõ|
| [WhatPulse](https://whatpulse.org/pages/webapi/) | Ứng dụng nhỏ đo mức sử dụng bàn phím/chuột của bạn                    | Không |  Có   | Không Rõ|
...
|                                                                API                                                                 | Mô Tả                                                                 |   Xác Thực   | HTTPS |  CORS   |
| :--------------------------------------------------------------------------------------------------------------------------------: | --------------------------------------------------------------------- | :----------: | :---: | :-----: |
|                                        [ADS-B Exchange](https://www.adsbexchange.com/data/)                                        | Truy cập dữ liệu thời gian thực và lịch sử của bất kỳ và tất cả các máy bay đang bay | Không |  Có   | Không Rõ|
|                                     [AIS Web](http://www.aisweb.aer.mil.br/api/doc/index.cfm)                                      | Thông tin hàng không trên phương tiện kỹ thuật số do Cục Kiểm soát Không phận (DECEA) sản xuất | `apiKey` |  Không| Không Rõ|
|                                 [Amadeus Travel Innovation Sandbox](https://sandbox.amadeus.com/)                                  | Tìm kiếm du lịch - Sử dụng hạn chế                                    | `apiKey`     |  Có   | Không Rõ|
|                                         [Aero Key, India](https://aerokey-api.vercel.app/)                                         | Dữ liệu sân bay nội địa Ấn Độ                                         | Không |  Có   |   Không|
|                                            [Uber](https://developer.uber.com/products)                                             | Yêu cầu đi xe Uber và ước tính giá                                    | `OAuth`      |  Có   |   Có    |
|                                           [Bay Area Rapid Transit](http://api.bart.gov)                                            | Các trạm và dự đoán đến cho BART                                      | `apiKey`     |  Không| Không Rõ|
|                                          [Unofficial BART API](https://bart.trentwil.es)                                           | Phiên bản ổn định của API kế thừa của BART                            | Không |  Có   | Không Rõ|
|                                               [BlaBlaCar](https://dev.blablacar.com)                                               | Tìm kiếm các chuyến đi chung xe                                       | `apiKey`     |  Có   | Không Rõ|
|           [Community Transit](https://github.com/transitland/transitland-datastore/blob/master/README.md#api-endpoints)            | API Transitland                                                      | Không |  Có   | Không Rõ|
|                                         [GraphHopper](https://graphhopper.com/api/1/docs/)                                         | Định tuyến A-to-B với hướng dẫn từng chặng                            | `apiKey`     |  Có   | Không Rõ|
|                                               [Icelandic APIs](http://docs.apis.is/)                                               | API mở cung cấp dịch vụ ở hoặc liên quan đến Iceland                  | Không |  Có   | Không Rõ|
|                                                 [Izi](http://api-docs.izi.travel/)                                                 | Hướng dẫn âm thanh cho khách du lịch                                  | `apiKey`     |  Có   | Không Rõ|
|                                   [Metro Lisboa](http://app.metrolisboa.pt/status/getLinhas.php)                                   | Sự chậm trễ trong các tuyến tàu điện ngầm                             | Không |  Không|   Không|
|                                                 [Navitia](https://api.navitia.io/)                                                 | API mở để xây dựng những thứ thú vị với dữ liệu giao thông            | `apiKey`     |  Có   | Không Rõ|
|                                   [Open Charge Map](https://openchargemap.org/site/develop/api)                                    | Sổ đăng ký công cộng toàn cầu về các địa điểm sạc xe điện             | Không |  Có   | Không Rõ|
|                             [REFUGE Restrooms](https://www.refugerestrooms.org/api/docs/#!/restrooms)                              | Cung cấp quyền truy cập vào nhà vệ sinh an toàn cho người chuyển giới, liên giới tính và không tuân thủ giới tính | Không |  Có   | Không Rõ|
|                                         [Schiphol Airport](https://developer.schiphol.nl/)                                         | Schiphol                                                             | `apiKey`     |  Có   | Không Rõ|
|                           [TransitLand](https://transit.land/documentation/datastore/api-endpoints.html)                           | Tổng hợp Giao thông                                                  | Không |  Có   | Không Rõ|
|                         [Transport for Atlanta, US](http://www.itsmarta.com/app-developer-resources.aspx)                          | Marta                                                                | Không |  Không| Không Rõ|
|                                   [Transport for Auckland, New Zealand](https://api.at.govt.nz/)                                   | Giao thông Auckland                                                  | Không |  Có   | Không Rõ|
|                                        [Transport for Belgium](https://hello.irail.be/api/)                                        | API giao thông Bỉ                                                    | Không |  Có   | Không Rõ|
|                         [Transport for Bordeaux, France](https://opendata.bordeaux-metropole.fr/explore/)                          | Giao thông công cộng Bordeaux Métropole và nhiều hơn nữa (Pháp)       | `apiKey`     |  Có   | Không Rõ|
|                                   [Transport for Boston, US](https://mbta.com/developers/v3-api)                                   | API MBTA                                                             | Không |  Không| Không Rõ|
|                                 [Transport for Budapest, Hungary](https://bkkfutar.docs.apiary.io)                                 | API giao thông công cộng Budapest                                    | Không |  Có   | Không Rõ|
|                               [Transport for Chicago, US](http://www.transitchicago.com/developers/)                               | CTA                                                                  | Không |  Không| Không Rõ|
|                          [Transport for Czech Republic](https://www.chaps.cz/eng/products/idos-internet)                           | API giao thông Séc                                                   | Không |  Có   | Không Rõ|
|                          [Transport for Denver, US](http://www.rtd-denver.com/gtfs-developer-guide.shtml)                          | RTD                                                                  | Không |  Không| Không Rõ|
|                                   [Transport for Finland](https://digitransit.fi/en/developers/)                                   | API giao thông Phần Lan                                              | Không |  Có   | Không Rõ|
|                             [Transport for Germany](http://data.deutschebahn.com/dataset/api-fahrplan)                             | API Deutsche Bahn (DB)                                               | `apiKey`     |  Không| Không Rõ|
|                               [Transport for Grenoble, France](https://data.mobilites-m.fr/donnees)                                | Giao thông công cộng Grenoble                                        | Không |  Không|   Không|
|                                  [Transport for Honolulu, US](http://hea.thebus.org/api_info.asp)                                  | Thông tin Giao thông Honolulu                                        | `apiKey`     |  Không| Không Rõ|
|                                    [Transport for India](https://data.gov.in/sector/transport)                                     | API Giao thông Công cộng Ấn Độ                                        | `apiKey`     |  Có   | Không Rõ|
|                             [Transport for Lisbon, Portugal](https://emel.city-platform.com/opendata/)                             | Dữ liệu về các tuyến xe buýt, bãi đậu xe và giao thông                | `apiKey`     |  Có   | Không Rõ|
|                                      [Transport for London, England](https://api.tfl.gov.uk)                                       | API TfL                                                              | Không |  Có   | Không Rõ|
|                                  [Transport for Manchester, England](https://developer.tfgm.com/)                                  | Dữ liệu mạng lưới giao thông TfGM                                     | `apiKey`     |  Có   |   Không|
|                           [Transport for Ottawa, Canada](http://www.octranspo.com/index.php/developers)                            | API đến xe buýt tiếp theo của OC Transpo                              | Không |  Không| Không Rõ|
|                            [Transport for Paris, France](http://restratpws.azurewebsites.net/swagger/)                             | Lịch trình trực tiếp được đơn giản hóa                               | Không |  Không| Không Rõ|
|                       [Transport for Paris, France](http://data.ratp.fr/api/v1/console/datasets/1.0/search/)                       | API Dữ liệu Mở RATP                                                  | Không |  Không| Không Rõ|
|                                 [Transport for Philadelphia, US](http://www3.septa.org/hackathon/)                                 | API SEPTA                                                            | Không |  Không| Không Rõ|
| [Transport for Sao Paulo, Brazil](http://www.sptrans.com.br/desenvolvedores/api-do-olho-vivo-guia-de-referencia/documentacao-api/) | SPTrans                                                              | `OAuth`      |  Không| Không Rõ|
|                                        [Transport for Sweden](https://www.trafiklab.se/api)                                        | Người tiêu dùng Giao thông Công cộng                                  | `OAuth`      |  Có   | Không Rõ|
|                                  [Transport for Switzerland](https://opentransportdata.swiss/en/)                                  | Dữ liệu Mở Giao thông Công cộng Thụy Sĩ Chính thức                   | `apiKey`     |  Có   | Không Rõ|
|                                    [Transport for Switzerland](https://transport.opendata.ch/)                                     | API giao thông công cộng Thụy Sĩ                                      | Không |  Có   | Không Rõ|
|                              [Transport for The Netherlands](http://www.ns.nl/reisinformatie/ns-api)                               | NS, chỉ có tàu                                                        | `apiKey`     |  Không| Không Rõ|
|                          [Transport for The Netherlands](https://github.com/skywave/KV78Turbo-OVAPI/wiki)                          | OVAPI, giao thông công cộng trên toàn quốc                            | Không |  Có   | Không Rõ|
|                                    [Transport for Toronto, Canada](https://myttc.ca/developers)                                    | TTC                                                                  | Không |  Có   | Không Rõ|
|                        [Transport for United States](http://www.nextbus.com/xmlFeedDocs/NextBusXMLFeed.pdf)                        | API NextBus                                                          | Không |  Không| Không Rõ|
|                                 [Transport for Vancouver, Canada](https://developer.translink.ca/)                                 | TransLink                                                            | `OAuth`      |  Có   | Không Rõ|
|                                    [Transport for Washington, US](https://developer.wmata.com/)                                    | API giao thông Metro Washington                                      | `OAuth`      |  Có   | Không Rõ|
|                                            [Uber](https://developer.uber.com/products)                                             | Yêu cầu đi xe Uber và ước tính giá                                    | `OAuth`      |  Có   |   Có    |
|                                  [WhereIsMyTransport](https://developer.whereismytransport.com/)                                   | Nền tảng dữ liệu giao thông công cộng ở các thành phố mới nổi         | `OAuth`      |  Có   | Không Rõ|
...
|                          API                          | Mô Tả                                    |   Xác Thực   | HTTPS |  CORS   |
| :---------------------------------------------------: | ---------------------------------------- | :----------: | :---: | :-----: |
|    [Bitly](http://dev.bitly.com/get_started.html)     | Trình rút gọn URL và quản lý liên kết    | `OAuth`      |  Có   | Không Rõ|
|         [CleanURI](https://cleanuri.com/docs)         | Dịch vụ rút gọn URL                      | Không |  Có   |   Có    |
| [Rebrandly](https://developers.rebrandly.com/v1/docs) | Trình rút gọn URL tùy chỉnh để chia sẻ liên kết có thương hiệu | `apiKey` |  Có   | Không Rõ|
|              [T.LY](https://t.ly/docs/)               | Trình rút gọn URL với các liên kết ngắn  | `apiKey`     |  Có   | Không Rõ|
...
|                                  API                                   | Mô Tả                                                                 |   Xác Thực   | HTTPS |  CORS   |
| :--------------------------------------------------------------------: | --------------------------------------------------------------------- | :----------: | :---: | :-----: |
| [Brazilian Vehicles and Prices](https://deividfortuna.github.io/fipe/) | Thông tin về phương tiện từ Fundação Instituto de Pesquisas Econômicas - Fipe | Không |  Có   | Không Rõ|
|      [CarsXE API](https://api.carsxe.com/?ref=public-apis-github)      | Dữ liệu phương tiện và bộ giải mã vin, thông số kỹ thuật, biển số, giá thị trường, chi phí sở hữu và hình ảnh | `apiKey` |  Có   | Không Rõ|
|     [Kelley Blue Book](http://developer.kbb.com/#!/data/1-Default)     | Thông tin phương tiện, giá cả, cấu hình và nhiều hơn nữa              | `apiKey`     |  Có   |   Không|
|       [Mercedes-Benz](https://developer.mercedes-benz.com/apis)        | Dữ liệu viễn thông, truy cập từ xa các chức năng của phương tiện, trình cấu hình xe, định vị đại lý dịch vụ | `apiKey` |  Có   |   Không|
|                [NHTSA](https://vpic.nhtsa.dot.gov/api/)                | Danh mục Thông tin Sản phẩm và Danh sách Phương tiện của NHTSA        | Không |  Có   | Không Rõ|
|                 [Smartcar](https://smartcar.com/docs/)                 | Khóa và mở khóa phương tiện và lấy dữ liệu như số đo quãng đường và vị trí. Hoạt động trên hầu hết các xe mới | `OAuth` |  Có   |   Có    |
...
|                                                API                                                 | Mô Tả                                                                 |   Xác Thực   | HTTPS |  CORS   |
| :------------------------------------------------------------------------------------------------: | --------------------------------------------------------------------- | :----------: | :---: | :-----: |
|                      [An API of Ice And Fire](https://anapioficeandfire.com/)                      | API Game Of Thrones                                                   | Không |  Có   | Không Rõ|
|                          [Bob's Burgers API](https://bobsburgersapi.com/)                          | API Bob's Burgers chứa dữ liệu cho hàng trăm nhân vật, tập phim, trò đùa và hình ảnh từ chương trình | Không |  Có   |   Có    |
|               [Breaking Bad Quotes](https://github.com/shevabam/breaking-bad-quotes)               | Một số câu trích dẫn từ Breaking Bad                                  | Không |  Có   | Không Rõ|
|                  [Czech Television](http://www.ceskatelevize.cz/xml/tv-program/)                   | Chương trình truyền hình của Đài truyền hình Séc                      | Không |  Không| Không Rõ|
|                         [Dailymotion](https://developer.dailymotion.com/)                          | API Nhà phát triển Dailymotion                                        | `OAuth`      |  Có   | Không Rõ|
|                            [Dune](https://github.com/ywalia01/dune-api)                            | API Dune                                                              | Không |  Có   | Không Rõ|
|                             [Harry Potter](https://www.potterapi.com/)                             | API Harry Potter                                                      | `apiKey`     |  Có   |   Có    |
|                           [Open Movie Database](http://www.omdbapi.com/)                           | Thông tin phim                                                        | `apiKey`     |  Có   | Không Rõ|
|                    [Owen Wilson Wow](https://owen-wilson-wow-api.onrender.com/)                    | API cho các câu cảm thán "wow" của diễn viên Owen Wilson trong phim   | Không |  Có   |   Có    |
|                                 [Potter DB](https://potterdb.com)                                  | Dữ liệu từ Vũ trụ Harry Potter: Nhân vật, Phim, Sách, Phép thuật và Độc dược | Không |  Có   | Không Rõ|
| [Ron Swanson Quotes](https://github.com/jamesseanwright/ron-swanson-quotes#ron-swanson-quotes-api) | Truyền hình                                                           | Không |  Có   | Không Rõ|
|                             [Shrek Quotes](https://shrekofficial.com)                              | Câu trích dẫn từ Shrek và nhiều hơn nữa, nhưng chủ yếu là câu trích dẫn | Không |  Có   |   Có    |
|               [South Park Quotes](https://github.com/Thatskat/southpark-quotes-api)                | Một API khá đơn giản cho phép bạn truy xuất một số câu trích dẫn hay nhất từ South Park, mmkay! | Không |  Có   |   Có    |
|                                     [STAPI](https://stapi.co)                                      | Thông tin về tất cả mọi thứ liên quan đến Star Trek                   | Không |  Có   |   Có    |
|                        [TMDb](https://www.themoviedb.org/documentation/api)                        | Dữ liệu phim dựa trên cộng đồng                                       | `apiKey`     |  Có   | Không Rõ|
|                                [Trakt](https://trakt.tv/b/api-docs)                                | Dữ liệu phim và truyền hình                                           | `apiKey`     |  Có   |   Có    |
|                              [TVDB](https://api.thetvdb.com/swagger)                               | Dữ liệu truyền hình                                                   | `apiKey`     |  Có   | Không Rõ|
|                                [TVMaze](http://www.tvmaze.com/api)                                 | Dữ liệu chương trình truyền hình                                      | Không |  Không| Không Rõ|
|                               [Vimeo](https://developer.vimeo.com/)                                | API Nhà phát triển Vimeo                                              | `OAuth`      |  Có   | Không Rõ|
|                         [YouTube](https://developers.google.com/youtube/)                          | Thêm chức năng YouTube vào các trang web và ứng dụng của bạn          | `OAuth`      |  Có   | Không Rõ|
|                                 [Shotstack](https://shotstack.io/)                                 | Phát triển các ứng dụng video với API chỉnh sửa video dựa trên đám mây | `apiKey`     |  Có   | Không Rõ|
...
|                                          API                                           | Mô Tả                                                                 |   Xác Thực   | HTTPS |  CORS   |
| :------------------------------------------------------------------------------------: | --------------------------------------------------------------------- | :----------: | :---: | :-----: |
|                   [7Timer!](http://www.7timer.info/doc.php?lang=en)                    | Thời tiết, đặc biệt là cho Astroweather                                | Không |  Không| Không Rõ|
|                    [APIXU](https://www.apixu.com/doc/request.aspx)                     | Thời tiết                                                             | `apiKey`     |  Có   | Không Rõ|
|                          [DWD API](https://dwd.api.bund.dev/)                          | API của Dịch vụ Thời tiết Đức (DWD): dữ liệu thời tiết, dữ liệu từ các trạm thời tiết cụ thể, cảnh báo (địa phương, bờ biển, biển, núi cao) | Không |  Có   | Không Rõ|
|         [Meteorologisk Institutt](https://api.met.no/weatherapi/documentation)         | Dữ liệu thời tiết và khí hậu                                          | Không |  Có   | Không Rõ|
|                [NOAA Climate Data](https://www.ncdc.noaa.gov/cdo-web/)                 | Dữ liệu thời tiết và khí hậu                                          | `apiKey`     |  Có   | Không Rõ|
|               [ODWeather](http://api.oceandrivers.com/static/docs.html)                | Thời tiết và webcam thời tiết                                         | Không |  Không| Không Rõ|
|                         [Open-Meteo](https://open-meteo.com/)                          | API dự báo thời tiết toàn cầu cho mục đích phi thương mại             | Không |  Có   |   Có    |
|                            [OpenUV](https://www.openuv.io)                             | Dự báo Chỉ số UV theo thời gian thực                                  | `apiKey`     |  Có   | Không Rõ|
|                    [OpenWeatherMap](http://openweathermap.org/api)                     | Thời tiết                                                             | `apiKey`     |  Không| Không Rõ|
|                         [Storm Glass](https://stormglass.io/)                          | Thời tiết biển toàn cầu từ nhiều nguồn                                 | `apiKey`     |  Có   |   Có    |
|              [Weather Hacks](http://weather.livedoor.com/weather_hacks/)               | Thời tiết, cho Nhật Bản                                               | Không |  Không|   Không|
|                      [Weatherbit](https://www.weatherbit.io/api)                       | Thời tiết                                                             | `apiKey`     |  Có   | Không Rõ|
|                      [Stormglass](https://docs.stormglass.io/#/)                       | Dự báo thời tiết & dữ liệu lịch sử từ các tổ chức khí tượng đáng tin cậy nhất thế giới trong một API duy nhất | `apiKey` |  Có   | Không Rõ|
| [National Weather Service API](https://www.weather.gov/documentation/services-web-api) | Dự báo thời tiết & dữ liệu lịch sử từ các tổ chức khí tượng đáng tin cậy nhất thế giới trong một API duy nhất | Không |  Có   | Không Rõ|
